...
description: Text analytics using LLM APIs — sentiment analysis, customer feedback
  classification, document entity extraction, multi-language support (English/Luganda/Swahili),
  feedback aggregation, and NLP feature implementation for PHP/Android/iOS. Sources...
metadata:
  portable: true
  compatible_with:
  - claude-code
