...
description: Language and tone standard for all written content. Enforces authentic
  East African English as used in Uganda, Kenya, and Tanzania — formal, clear, respectful,
  British-influenced, and professionally courteous. Apply to every piece of text...
metadata:
  portable: true
  compatible_with:
  - claude-code
...
- The task is unrelated to `east-african-english` or would be better handled by a more specific companion skill.
...
|----------|----------|--------|---------|
| UX quality | East-African English copy audit | Markdown doc reviewing East-African English tone, idiom, and authenticity per page | `docs/content/east-african-audit.md` |
