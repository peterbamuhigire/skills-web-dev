...
description: "Report UI rule for mobile apps: any report with potential for more than 25 rows must render as a table, not cards. Includes decision rules, Android Compose patterns, and iOS SwiftUI patterns."
---
