...
**Superpowers plugin:** MUST be active for all work using this skill. Use throughout the entire build pipeline — data analysis, documentation generation, quality checks, and any task where it offers enhanced capabilities.
