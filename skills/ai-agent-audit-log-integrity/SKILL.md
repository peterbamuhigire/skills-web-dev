---
name: ai-agent-audit-log-integrity
description: Use when designing the **tamper-evident** action audit log for an agentic SaaS — hash-chained, write-once storage, retention by event class (7yr financial, 6yr HIPAA, configurable for SOC 2 / ISO), nightly integrity verification job, and export-on-audit-request. Foundation for SOC 2 PI1.1, HIPAA §164.312(b), ISO 27001 A.8.15.
metadata:
  portable: true
  compatible_with:
  - claude-code
