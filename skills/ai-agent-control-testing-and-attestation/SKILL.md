---
name: ai-agent-control-testing-and-attestation
description: Use when building automated control tests that run on cadence and produce auditor-friendly reports — failure → ticket; attestation evidence packs for SOC 2 Type II window, ISO surveillance, HIPAA periodic review. Operationalises the controls defined in the SOC 2 / ISO / HIPAA skills.
metadata:
  portable: true
  compatible_with:
  - claude-code
