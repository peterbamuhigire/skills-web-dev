---
name: ai-agent-iso27001-controls
description: Use when implementing ISO/IEC 27001:2022 Annex A controls relevant to agentic SaaS — A.5 organisational policies, A.6 people, A.8 asset management for tools/prompts/models, A.5/A.8 access, A.12 operations, A.14 secure development for prompts, A.16 incident management, A.18 compliance. Engineering side; pair with the SRS engine for the Statement of Applicability, risk register, and treatment plan.
metadata:
  portable: true
  compatible_with:
  - claude-code
